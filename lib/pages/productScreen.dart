                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            'Категория:',
                            style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: AppColors.oliveGray.withOpacity(0.5)),
                          ),
                          const SizedBox(width: 4),
                          Text(
                            widget.product.category.isNotEmpty ? widget.product.category : 'Не указана',
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 4),
                          Text(
                            widget.product.subcategory.isNotEmpty ? widget.product.subcategory : 'Не указана',
                            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: AppColors.oliveGray),
                          ),
                        ],
                      ),
